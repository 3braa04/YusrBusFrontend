...
<div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-slate-50 dark:bg-background transition-colors duration-500">
    ...
    <div className="absolute inset-0">
      <div
        className="absolute -top-[10%] left-[15%] h-150 w-150 rounded-full 
                   bg-primary/10 blur-[120px] 
                   dark:bg-primary/10 dark:blur-[120px]"
      />
      <div
        className="absolute top-[30%] -right-[5%] h-125 w-125 rounded-full 
                   bg-primary/10 blur-[100px] 
                   dark:primary/5 dark:blur-[100px]"
      />
      <div
        className="absolute -bottom-[10%] left-[20%] h-175 w-175 rounded-full 
    ...
    <svg className="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M0 200 L1000 200" stroke="url(#line-grad)" strokeWidth="1" fill="none" className="text-indigo-500 dark:text-primary" />
      <path d="M0 600 L1000 600" stroke="url(#line-grad)" strokeWidth="1" fill="none" className="text-indigo-500 dark:text-primary" />
