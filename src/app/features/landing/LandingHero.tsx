...
export default function LandingHero()
{
    return (
        ...
        <p className="mx-auto mt-8 max-w-2xl text-lg font-medium leading-relaxed text-muted-foreground md:text-xl">
          منصة شاملة تُمكّنك من إدارة رحلات الحافلات، إصدار التذاكر، وتسجيل الركاب 
          عبر حلول تقنية متطورة مصممة لرفع كفاءة النقل العام.
        </p>

        {/* 5. Buttons: Standard shadcn button variants */}
        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link to="/login">
            <Button size="lg" className="h-14 rounded-full px-10 text-lg shadow-lg shadow-primary/20 transition-transform hover:scale-[1.02] active:scale-[0.98]">
              ابدأ الآن <ArrowLeft className="mr-2 h-5 w-5" />
            </Button>
          </Link>
          <a href="#features">
            <Button size="lg" variant="outline" className="h-14 rounded-full px-10 text-lg backdrop-blur-sm transition-transform hover:scale-[1.02] active:scale-[0.98]">
              استعرض المزايا
            </Button>
          </a>
        </div>
