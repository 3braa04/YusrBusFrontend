        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f, i) => {
            ...
            return (
              ...
              <Card key={i} className="group flex flex-col transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:border-primary/50">
                ...
                <CardContent className="flex flex-1 flex-col gap-4">
                  ...
                  <div className="mt-auto pt-1">
                    <Link to={f.to}>
                      <Button variant="outline" size="sm" className="w-full gap-2 group-hover:border-primary/50 group-hover:bg-primary/5 group-hover:text-primary">
